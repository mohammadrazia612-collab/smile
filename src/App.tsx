    ...
    <div className="aura-app" style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      <main style={{ flex: 1 }}>
        ...
        <Hero
          ...
          splineSceneUrl={null} /* Ready for future Spline scene */
        />

        {/* 2. Animated / Popping Statistics (Triggered immediately on page open) */}
        <Statistics />
        ...
        {/* 6. Patient Experience / Why Choose Us (Acoustic sanctuary) */}
        <PatientExperience />

        {/* 7. Interactive Physics Cluster (Inertia & Anatomy popups) */}
        <InteractiveCluster />
        ...
        {/* 9. Testimonials ("What Our Patients Say" slider) */}
        <Testimonials />

        {/* 10. Trust & Key Benefits */}
        <TrustBenefits />

        {/* 11. Meet Our Doctors (Specialist profile cards) */}
        <DoctorsTeam onBookConsultation={handleSelectTreatmentForBooking} />

        {/* 12. Technology / Modern Dentistry (Apple keynote showcase) */}
        <Technology />

        {/* 13. FAQ Accordion */}
        <FAQSection />

        {/* 14. Strong Appointment CTA & Request Form */}
        <AppointmentSection ref={appointmentRef} initialTreatment={selectedTreatment} />

        {/* 15. Studio Contact, Clinical Schedule & Concierge */}
        <ContactSection />
      </main>

      {/* 16. Minimalist Apple-Style Footer */}
      <Footer />
    </div>
  );
};
